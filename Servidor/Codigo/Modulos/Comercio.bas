...
'ULISES ASIGNAMOS VALOR A LA VARIABLE CHIVATO DE CABALLOS
OBJETO_TIPO = ObjData(obji).ObjType
...
End If
    ...
    'ULISES CORRECCION DE VENTA DE CABALLOS

    If (OBJTYPE_CABALLOS = OBJETO_TIPO) Then
