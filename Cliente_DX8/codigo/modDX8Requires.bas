...
' [Adaptado] jojoparticulas() eliminado - llamaba a Particle_Group_Make/Light_Create/Light_Render_All
' que fueron eliminados del engine por usar MapData.particle_group y MapData.light_value
' (campos inexistentes en el tipo MapBlock de este proyecto).
