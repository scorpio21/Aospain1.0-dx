    ...
    If EngineRun Then
        ...
        '[END]'
            ...
            '[CODE 000]:MatuX
                ...
                Call engine.Render  ' [DX8] Present del frame via D3DDevice
...
If bNoResChange = False Then
    ' [DX8] Direct3D8 en modo ventana no cambia la resolucion del escritorio,
    ' por lo que no hay que restaurarla al salir.
End If
